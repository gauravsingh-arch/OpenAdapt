...
scrubber = PresidioScrubbingProvider()
print("hi34§")
image = Image.open("Screenshot_PII_Testing.png")
print("hi34§67")
...
# Usage
loader = SQLiteRecordingLoader("Recordingdb_PII_Scrub/recordings.db")
scrubber = PresidioScrubbingProvider()
print("hi23456",loader)
# Load, scrub, and save
scrubbed = loader.load_and_scrub("recordings_001.mp4", scrubber, False)
print("hi987")
